...
void execute_r (int rs, int rt, int rd, unsigned int shamt, unsigned int funct) {
    ...
    switch (funct) {
        case (SLL): //SLL
            ...
            printf ("Cycle:%d %.8x\t%.8x\t SLL R%-2d, R%-2d, #%-d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (SRL): //SRL
            NEXT_STATE.REGS[rd] = CURRENT_STATE.REGS[rt] >> shamt;
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t SRL R%-2d, R%-2d, #%-d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (SRA): //SRA
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t SRA R%-2d, R%-2d, #%-d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (ADD): //ADD
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t ADD R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (SUB): //SUB
            NEXT_STATE.REGS[rd] = (int32_t)(CURRENT_STATE.REGS[rs] - CURRENT_STATE.REGS[rt]);
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t SUB R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (AND): //AND
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t AND R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (OR): //OR
            NEXT_STATE.REGS[rd] = CURRENT_STATE.REGS[rs] | CURRENT_STATE.REGS[rt];
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t OR R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (XOR): //XOR
            NEXT_STATE.REGS[rd] = CURRENT_STATE.REGS[rs] ^ CURRENT_STATE.REGS[rt];
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t XOR R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (NOR): //NOR
            NEXT_STATE.REGS[rd] = ~(CURRENT_STATE.REGS[rs] | CURRENT_STATE.REGS[rt]);
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t NOR R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        case (SLT): //SLT
            ...
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t SLT R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
        ...
        break;
        case (MUL): //MUL
            NEXT_STATE.REGS[rd] = (long long int)(CURRENT_STATE.REGS[rs] * CURRENT_STATE.REGS[rt]);
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t%.8x\t MUL R%-2d, R%-2d, R%-2d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rd,
...
void execute_i (unsigned int opcode, int rs, int rt, int imm) {
    ...
    switch (opcode) {
        case (BEQ): //BEQ
            ...
            printf ("Cycle:%d %.8x\t:%.8x\t BEQ R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        case (BNE): //BNE
            ...
            printf ("Cycle:%d %.8x\t:%.8x\t BNE R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        case (BLEZ): //BLEZ
            ...
            printf ("Cycle:%d %.8x\t:%.8x\t BLEZ R%-2d, R0, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rs,
        ...
        case (BGTZ): //BGTZ
            ...
            printf ("Cycle:%d %.8x\t:%.8x\t BGTZ R%-2d, R0, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rs,
        ...
        break;
        case (ADDI): //ADDI
            printf ("Cycle:%d %.8x\t:%.8x\t ADDI R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        case (SLTI): //SLTI
            ...
            imm = (sign) ? (imm | shift_val) : imm;
            printf ("Cycle:%d %.8x\t:%.8x\t SLTI R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        break;
        case (ANDI): //ANDI
            printf ("Cycle:%d %.8x\t:%.8x\t ANDI R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        break;
        case (ORI): //ORI
            printf ("Cycle:%d %.8x\t:%.8x\t ORI R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        break;
        case (XORI): //XORI
            printf ("Cycle:%d %.8x\t:%.8x\t XORI R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        case (LW): //LW
            ...
            mem_content = memory[(unsigned int)address];
            printf ("Cycle:%d %.8x\t:%.8x\t LW R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
        ...
        case (SW): //SW
            ...
            address = (CURRENT_STATE.REGS[rs] + imm) & 0xFFFFFFFC;
            memory[address] = NEXT_STATE.REGS[rt];
            NEXT_STATE.PC = CURRENT_STATE.PC + 4;
            printf ("Cycle:%d %.8x\t:%.8x\t SW R%-2d, R%-2d, #%d\n", 
                instr_count,
                CURRENT_STATE.PC,
                instr_opcode,
                rt,
...
void process_instruction() {
    instr_opcode = memory[CURRENT_STATE.PC];
